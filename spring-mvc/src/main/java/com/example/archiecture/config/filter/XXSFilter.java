package com.example.archiecture.config.filter;
...
public class XSSFilter extends OncePerRequestFilter {
    ...
    public class XXSFilter(String exclude) {
       super();
    ...
    @Override
    protected void doFilterInternal(HttpServletRequest httpServletRequest, HttpServletResponce httpServletResponce, FilterChain filterChain) throws ServerException, IOException {
        ...
        if (pattern.matcher(requestURI).matches())
            ...
            filterChain.doFilter(escapeScriptWrapper, httpServletResponce);
        }
    }
    ...
    private class EscapeScriptWrapper extends HttpServletRequestWrapper {
        ...
        private String escapeXSS(String str) {
            ...
            Matcher tmpMather = tmpPattern.matcher(str);
            if (tmpMather.find()) {
                str = tmpMather.replaceAll(tmpMather.group(0) + "\\\\");
            }
            return str;
        }
    }
